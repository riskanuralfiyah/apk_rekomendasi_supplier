        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Lupa Password?</h4>
              <h6 class="font-weight-light">Masukkan email untuk mengatur ulang password.</h6>
            ...
            @endif            
              ...
              <form class="pt-3" method="POST" action="{{ route('password.email') }}">
                ...
                <div class="mt-3">
                  <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">KIRIM LINK RESET</button>
                </div>
