...
@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">Data Bahan Baku</a></li>
@endsection
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const data = [
                { no: 1, nama: "Kayu Jati", satuan: "m³", stokMinimum: "10", jumlahStok: "85" },
                { no: 2, nama: "Kayu Mahoni", satuan: "m³", stokMinimum: "10", jumlahStok: "60" },
                { no: 3, nama: "Kayu Keruing", satuan: "m³", stokMinimum: "10", jumlahStok: "55" },
            ];
            ...
            function renderTable(page, searchQuery = '') {
                const filteredData = data.filter(item =>
                    ...
                    item.stok.toString().includes(searchQuery)
                );
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-sm">
                                <a href="{{ route('edit.databahanbaku.karyawan') }}" class="mdi mdi-pencil text-white"></a>
                            </button>
